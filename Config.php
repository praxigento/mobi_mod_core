...
class Config
{
    ...
    const E_SALE_ORDER_GRID_A_SHIPPING_NAME = 'shipping_name';
    const E_SALE_ORDER_GRID_A_SIGNIFYD_GUARANTEE_STATUS = 'signifyd_guarantee_status';
    const E_SALE_ORDER_GRID_A_STATUS = 'status';
    const E_SALE_ORDER_GRID_A_STORE_ID = 'store_id';
