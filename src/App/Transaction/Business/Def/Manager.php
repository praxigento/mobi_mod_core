...
class Manager
    implements \Praxigento\Core\App\Transaction\Business\IManager
{
    /**
     * Starting level for the first transaction.
     */
    const ZERO_LEVEL = 0;
    /** @var \Praxigento\Core\App\Transaction\Business\IFabrique */
    private $factoryTrans;
    /**
     * @var array [$transactionName][$level] => \Praxigento\Core\App\Transaction\Business\IItem
     */
    private $registry = [];

    public function __construct(
        \Praxigento\Core\App\Transaction\Business\IFabrique $factoryTrans
    ) {
