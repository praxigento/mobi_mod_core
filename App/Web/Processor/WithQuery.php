...
abstract class WithQuery
{
    ...
    protected function prepareQueryConditions(\Praxigento\Core\Data $ctx) {
        /* get working vars from context */
        $vars = $ctx->get(self::CTX_VARS);
        /** @var \Praxigento\Core\Api\App\Web\RequestCond $req */
     ...
     *
     * @param \Praxigento\Core\Api\App\Web\Request $data
     * @return \Praxigento\Core\Api\App\Web\Response
     */
    protected function process(\Praxigento\Core\Api\App\Web\Request $data) {
