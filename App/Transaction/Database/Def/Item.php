 ...
 */
class Item
    implements \Praxigento\Core\App\Transaction\Database\IItem
{
    /** @var  \Magento\Framework\DB\Adapter\AdapterInterface */
    private $_conn;
    /** @var  int */
    private $_level = \Praxigento\Core\App\Transaction\Database\IManager::ZERO_LEVEL;
    /** @var  string */
    private $_nameConn = \Praxigento\Core\App\Transaction\Database\IManager::DEF_CONNECTION;
    /** @var  string */
    private $_nameTran = \Praxigento\Core\App\Transaction\Database\IManager::DEF_TRANSACTION;
    ...
    {
        $result = new \Praxigento\Core\App\Transaction\Database\Def\Definition(
            $this->_nameTran,
            $this->_nameConn,
            $this->_level
        );
