    ...
    implements \Praxigento\Core\App\Api\Logger\Main
{
    ...
    public function __construct()
    {
        ...
        $processors = [];
        parent::__construct(self::NAME, $handlers, $processors);
    }

    public function log($level, $message, array $context = array())
    {
        return parent::log($level, $message, $context); // TODO: Change the autogenerated stub
    }
